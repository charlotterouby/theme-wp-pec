...
<ul class="tribe-events-sub-nav nav-links">
    ...
    <?php if ( tribe_has_previous_event() ) : ?>
        <li class="<?php echo esc_attr( tribe_left_navigation_classes(' page-prev nav-previous') ); ?>" aria-label="previous events link">
    ...
    <?php if ( tribe_has_next_event() ) : ?>
        <li class="<?php echo esc_attr( tribe_right_navigation_classes('page-next nav-next') ); ?>" aria-label="next events link">
