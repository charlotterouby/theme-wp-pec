...
<div class="tribe-events-meta-group mdl-cell mdl-grid mdl-grid--no-spacing tribe-events-meta-group-organizer">
    <h3 class="tribe-events-single-section-title mdl-cell mdl-cell--12-col"><?php echo tribe_get_organizer_label( ! $multiple ); ?></h3>
